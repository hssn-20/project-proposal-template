...
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------- | ------------- | ------------ | -------------- | ---------------- | ----------------------------------------------------------------- | --------------- | -------- | ---------- |
| Optimal Tokenizer            | Whats the best tokenizer method? Whats the optimal kmer length? What are the trade offs with regards to tokenization in this context? What do we lose, what do we gain, information wise?                                                        | 4 hrs    | 15 hrs        | Yes          | Yes            | Yes              | k-mer, vocab size                                                 | ~ model size    | Loss     | Blog 1     |
...
| Wavelet-based model scaling  | As we increase context windows and model params, does loss go down in commiserate manner?                                                                                                                                                        | 4 hrs    | 50 hrs        | Yes          | Yes            | Yes              | Context Size, Model Params                                        | Training Data   | Loss     | Paper 2    |
